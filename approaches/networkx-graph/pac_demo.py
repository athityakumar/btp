...
class Concept(nx.Graph):
  ...
  def is_member(self, hypothesis, attributes_subset):
    ...
    # print("Attributes subset:", attributes_subset)
    # print("Attributes superset:", self.attributes_superset(attributes_subset))
    return(attributes_subset == self.attributes_superset(attributes_subset))
    # attributes_subset = set(attributes_subset)
    # for (antecedent_attrs, consequent_attrs) in hypothesis:
    #   if attributes_subset.issubset(antecedent_attrs):
    #     return(True)
    # return(False)
    # return(self.is_model_of_implications(attributes_subset, hypothesis))

  # def is_equivalent(self, implications):
  #   return(True)
